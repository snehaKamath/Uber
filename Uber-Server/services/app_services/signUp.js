...
function customer(message, callback)	{
	...
	var phone=Number(message.data[10]+message.data[11]);
	var email=message.data[12];
	var password=message.data[13];
	var cardnumber=message.data[14];
	var cardtype=message.data[15];
	var cvv=message.data[16];
	var expirydate=message.data[17]+"/"+message.data[18];
